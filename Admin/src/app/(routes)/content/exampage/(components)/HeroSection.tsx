...
import { ExamPageHeroSection } from "../types";

interface HeroSectionProps {
    data: ExamPageHeroSection;
    onChange: (updates: Partial<ExamPageHeroSection>) => void;
}

export default function HeroSection({ data, onChange }: HeroSectionProps) {
    return (
        <ContentSection
            id="exam-page-hero-section"
            title="Hero Section"
            description="Manage the title and description for the Exam Page."
