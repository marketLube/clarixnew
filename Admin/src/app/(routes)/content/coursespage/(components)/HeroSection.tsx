...
import { CoursesPageHeroSection } from "../types";

interface HeroSectionProps {
    data: CoursesPageHeroSection;
    onChange: (updates: Partial<CoursesPageHeroSection>) => void;
}

export default function HeroSection({ data, onChange }: HeroSectionProps) {
    return (
        <ContentSection
            id="courses-page-hero-section"
            title="Hero Section"
            description="Manage the title and description for the Courses Page."
