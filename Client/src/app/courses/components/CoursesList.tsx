    ...
    <>
      ...
      {courses.length === 0 ? (
        <div className="w-full flex flex-col items-center justify-center py-20 px-4 mt-8 rounded-2xl border border-[#edf0f9] bg-[#fafbff]">
          ...
          <p className="font-poppins text-[#767e92] text-sm text-center max-w-md">We&apos;re adding new courses regularly. Please check back soon or try a different filter.</p>
        </div>
      ) : (
      <div
        ref={coursesGridRef}
