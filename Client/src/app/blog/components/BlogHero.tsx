...
export default function BlogHero({ onSearch }: BlogHeroProps) {
  ...
  return (
    <section className="relative min-h-[560px] w-full overflow-hidden bg-gradient-to-br from-[#513392] via-[#6041ad] to-[#6846b6]">
      <ContentWrapper className="relative h-full py-16">
        {/* Breadcrumb */}
