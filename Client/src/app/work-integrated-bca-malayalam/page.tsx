...
const benefits = [
  ...
  },
  {
    title: "Hybrid Mode",
    description:
      "Online + Offline ഒരുമിച്ച്. എപ്പോൾ വേണമെങ്കിലും പഠിക്കാം.",
  },
  {
    title: "Year 2-ൽ Work!",
    description:
      "Top MNCs-ൽ join ചെയ്യാം. Stipend കിട്ടും, experience-ഉം.",
  },
  {
    title: "Placement ഉറപ്പ്",
    description:
      "Industry തന്നെ syllabus ഉണ്ടാക്കിയത്. ജോലിയിലാണ് പുറത്തിറങ്ങുന്നത്.",
  },
];
...
const timeline = [
  ...
  },
  {
    ...
    label: "Work തുടങ്ങാം!",
    description:
      "Real teams, real products, real stipend. പഠിക്കുമ്പോൾ തന്നെ company experience.",
  },
  {
    year: "Year 3",
    label: "Career Launch",
    description:
      "Degree + 2 വർഷം experience. അതേ company തന്നെ full-time offer തരും.",
  },
];
...
export default function WorkIntegratedBcaMalayalamLanding() {
  return (
    <div lang="ml" className="w-full bg-[#f6f7ff] text-[#162447] font-poppins">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-12 items-center">
            <div className="lg:col-span-7 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#513392]/20 bg-white/80 backdrop-blur px-3 py-1 md:py-1.5 mb-3 md:mb-5 shadow-[0_2px_8px_rgba(81,51,146,0.08)]">
                ...
                <span className="text-[11px] md:text-[13px] font-medium tracking-[0.02em] text-[#513392]">
                  ഇന്ത്യയിലെ ആദ്യത്തെ Work-Integrated BCA
                </span>
              </div>
            ...
            <div className="lg:hidden flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-[14px] text-[#4b5468] leading-relaxed max-w-[460px] px-2">
                Hybrid BCA. Year 2 മുതൽ top companies-ൽ ജോലിയും salary-യും.
                Degree കൂടി കിട്ടും!
              </p>
              <a
                href={WHATSAPP_URL}
      ...
      <section className="bg-white border-y border-[#eef0ff]">
        <div className="mx-auto max-w-[1280px] px-4 py-12 md:px-8 md:py-20 lg:py-24">
          <div className="max-w-[760px] text-center lg:text-left mx-auto lg:mx-0">
            ...
            <h2 className="mt-3 text-[24px] sm:text-[30px] md:text-[40px] lg:text-[44px] font-semibold tracking-[-0.01em] leading-tight text-[#162447]">
              Real ജോലിക്ക് വേണ്ടി ഉണ്ടാക്കിയ Degree.
            </h2>
          </div>
      ...
      <section className="bg-[#f6f7ff]">
        <div className="mx-auto max-w-[1280px] px-4 py-12 md:px-8 md:py-20 lg:py-24">
          <div className="max-w-[760px] text-center lg:text-left mx-auto lg:mx-0">
            ...
            <h2 className="mt-3 text-[24px] sm:text-[30px] md:text-[40px] lg:text-[44px] font-semibold tracking-[-0.01em] leading-tight text-[#162447]">
              3 വർഷം. അതിൽ 2 വർഷം നിങ്ങൾ company-യിലാണ്!
            </h2>
          </div>

          <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
            {timeline.map((phase, idx) => (
              <div
                key={phase.year}
                className="relative rounded-[20px] bg-white border border-[#e1e3ff] p-5 md:p-7 transition-all hover:border-[#513392]/30 hover:shadow-[0_16px_40px_-20px_rgba(81,51,146,0.35)]"
              >
                <div className="flex items-baseline gap-3">
                  <span className="text-[26px] md:text-[34px] font-bold text-[#513392] tracking-[-0.02em]">
                    {phase.year}
                  </span>
                ...
                <p className="mt-3 text-[13px] md:text-[15px] text-[#4b5468] leading-relaxed">
                  {phase.description}
                </p>
      ...
      <section className="bg-white border-y border-[#eef0ff]">
        <div className="mx-auto max-w-[1280px] px-4 py-12 md:px-8 md:py-20 lg:py-24">
          <div className="max-w-[760px] text-center lg:text-left mx-auto lg:mx-0">
            ...
            <h2 className="mt-3 text-[24px] sm:text-[30px] md:text-[40px] lg:text-[44px] font-semibold tracking-[-0.01em] leading-tight text-[#162447]">
              നിങ്ങളുടെ Resume തുടങ്ങാൻ പോകുന്ന companies.
            </h2>
          </div>

          <div className="mt-8 md:mt-12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-4">
            {recruiters.map((name) => (
              <div
                key={name}
          ...
          <p className="mt-6 md:mt-8 text-center text-[13px] md:text-[14px] text-[#767e92]">
            …കൂടാതെ വേറെ ഒരുപാട് product-ഉം consulting-ഉം companies.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-12 md:px-8 md:py-20 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
            <div className="lg:col-span-6 text-center lg:text-left">
              <h2 className="text-[24px] sm:text-[30px] md:text-[40px] lg:text-[46px] font-semibold tracking-[-0.01em] leading-tight">
                നേരത്തെ start ചെയ്യണോ?
              </h2>
              ...
              <div className="mt-6 md:mt-8 flex justify-center lg:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-white text-[#513392] font-semibold text-[14px] md:text-[16px] px-5 py-3 md:px-7 md:py-4 hover:bg-[#f3eefe] transition-colors shadow-[0_10px_28px_rgba(0,0,0,0.18)]"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.077 4.487.71.306 1.263.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.42 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.83 9.83 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.82 11.82 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.88 11.88 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.82 11.82 0 0 0-3.48-8.413" />
                  </svg>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4 max-w-[480px] mx-auto lg:mx-0">
                <div>
                  <div className="text-[22px] md:text-[32px] font-bold tracking-[-0.02em]">
                    2 വർഷം
                  </div>
                  <div className="text-[11px] md:text-[13px] text-white/75 mt-1">
                    Work Experience
                  </div>
                </div>
                <div>
            ...
            <div className="lg:col-span-6">
              <div className="rounded-[20px] md:rounded-[24px] bg-white text-[#162447] p-4 md:p-7 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.5)]">
                <h3 className="text-[18px] md:text-[22px] font-semibold tracking-[-0.01em] text-center lg:text-left">
                  ഇന്ന് തന്നെ call back വാങ്ങാം
                </h3>
                <p className="mt-1 text-[12px] md:text-[14px] text-[#767e92] leading-snug md:leading-relaxed text-center lg:text-left">
                  Form fill ചെയ്യൂ. ബാക്കി WhatsApp-ൽ പറയാം!
                </p>
                <div className="mt-4 md:mt-5">
                  <LeadForm />
                </div>
