    ...
    <section className="w-full bg-white py-6 md:py-16 lg:py-20">
      <ContentWrapper className="flex flex-col items-center px-4 md:px-10">
        ...
        <header className="flex max-w-[567px] flex-col items-center gap-2 md:gap-3 text-center">
          ...
          <h2 className="font-poppins text-[20px] leading-[26px] tracking-[-0.02em] text-(--text-headline) sm:text-[24px] sm:leading-[30px] md:text-[28px] md:leading-[34px] lg:text-[36px] lg:leading-[42px] xl:text-[44px] xl:leading-[48px]">
            {title}
          </h2>
