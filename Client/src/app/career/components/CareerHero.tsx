...
export default function CareerHero() {
  ...
  return (
    <section className="hero-compact-landscape relative min-h-[220px] sm:min-h-[320px] md:min-h-[420px] lg:min-h-[520px] w-full overflow-hidden bg-gradient-to-br from-[#513392] via-[#6041ad] to-[#6846b6]">
